...
namespace UnityEngine.InputSystem.Samples.RebindUI
{
    ...
    /// hooks into <see cref="TMProRebindActionUI.updateBindingUIEvent"/> which is triggered when UI display
    ...
    public class GamepadIconsExample : MonoBehaviour
    {
        ...
        {
            // Hook into all updateBindingUIEvents on all TMProRebindActionUI components in our hierarchy.
