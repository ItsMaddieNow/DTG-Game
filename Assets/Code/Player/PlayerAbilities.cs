...
public class PlayerAbilities : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        GrapplingGun.transform.localPosition = new Vector2((PlayerMovementScript.FacingRight? 1 : -1) *  GrappleGunDirection.x,GrappleGunDirection.y);
        
        GrapplingGun.transform.rotation = Quaternion.Euler(0,GrappleDirection.x<0?0:180,Mathf.Rad2Deg * Mathf.Atan2((GrappleGunDirection * GunRadiusScale).y,(((GrappleDirection.x>0) ? -GrappleGunDirection:GrappleGunDirection) * GunRadiusScale).x));
